...
| <sup>3.3</sup> | <sup>Scan me to download the app! Engineering related talks will be held in Lecture Theatre J... K... and H. Besides, Consultation sessions will be provided for both DSE and non-DSE applicants.</sup> | <sup>Info Day app QR code</sup> | <sup>Related gestures</sup> |||
| <sup>4.1</sup> | <sup>DO you want to see something cool?</sup> | <sup>Info Day app QR code</sup> ||||
| <sup>4.2</sup> || <sup>Info Day app QR code</sup> | <sup>Lift forearm to 90 degrees</sup> || <sup>If `yes`, go to 4.3, otherwise go to 5.1</sup> |
| <sup>4.3</sup> | <sup>On campus today, you can watch robots battle against each other. You can even sign up to play!</sup> | <sup>Robomaster_image</sup> ||||
| <sup>4.4</sup> || <sup>Robomaster_image</sup> | <sup>Gorilla action</sup> | <sup>Machine gun sound</sup> ||
| <sup>4.5</sup> | <sup>You can see an electric vehicle built by our students</sup> | <sup>EVcar_image</sup> ||||
| <sup>4.6</sup> || <sup>EVcar_image</sup> | <sup>Driving action</sup> | <sup>Car sound</sup> ||
